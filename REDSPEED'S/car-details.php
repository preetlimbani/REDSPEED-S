...
$sql = "SELECT tblcar.*,tblcarbrand.BrandName,tblcarbrand.id as bid  from tblcar join tblcarbrand on tblcarbrand.id=tblcar.VehiclesBrand where tblcar.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
