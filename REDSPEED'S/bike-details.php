...
$sql = "SELECT tblbike.*,tblbikebrand.BrandName,tblbikebrand.id as bid  from tblbike join tblbikebrand on tblbikebrand.id=tblbike.VehiclesBrand where tblbike.id=:vhid";
$query = $dbh -> prepare($sql);
$query->bindParam(':vhid',$vhid, PDO::PARAM_STR);
$query->execute();
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>Rs.<?php echo htmlentities($result->PricePerDay);?> </p><b>Per Day</b>
